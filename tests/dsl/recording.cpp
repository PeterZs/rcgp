...
add_test(scalar_constant)
{
	...
	assert_assembly_eq(sbr, "recording/scalar_constant.asm");
};
...
add_test(binary_op)
{
	...
	assert_assembly_eq(sbr, "recording/binary_op.asm");
};
...
add_test(unary_op)
{
	...
	assert_assembly_eq(sbr, "recording/unary_op.asm");
};
...
add_test(assignment_store)
{
	...
	assert_assembly_eq(sbr, "recording/assignment_store.asm");
};
...
add_test(increment_decrement)
{
	...
	assert_assembly_eq(sbr, "recording/increment_decrement.asm");
};
...
add_test(type_caching)
{
	...
	assert_assembly_eq(sbr, "recording/type_caching.asm");
};
...
add_test(construct_vec3)
{
	...
	assert_assembly_eq(sbr, "recording/construct_vec3.asm");
};
...
add_test(swizzle_xyz)
{
	...
	assert_assembly_eq(sbr, "recording/swizzle_xyz.asm");
};
...
add_test(field_access)
{
	...
	assert_assembly_eq(sbr, "recording/field_access.asm");
};
...
add_test(array_access)
{
	...
	assert_assembly_eq(sbr, "recording/array_access.asm");
};
...
add_test(while_loop)
{
	...
	assert_assembly_eq(sbr, "recording/while_loop.asm");
};
...
add_test(for_loop)
{
	...
	assert_assembly_eq(sbr, "recording/for_loop.asm");
};
...
add_test(branching)
{
	...
	assert_assembly_eq(sbr, "recording/branching.asm");
};
...
add_test(switch_branch)
{
	...
	assert_assembly_eq(sbr, "recording/switch_branch.asm");
};
...
add_test(vector_store)
{
	...
	assert_assembly_eq(sbr, "recording/vector_store.asm");
};
